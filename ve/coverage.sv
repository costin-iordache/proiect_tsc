...
class coverage;
  ...
  covergroup vr_transaction_cg;
    ...
    valid_enable_cp: coverpoint trans_covered.valid;
  ...
  miso_data_cp: coverpoint spi_trans_covered.data {
    bins big_values = {[191:255]};
    bins medium_values = {[127:190]};
    bins low_values = {[0:126]};
  }
endgroup
  ...
  function print_coverage();
    ...
    $display ("Write data coverage = %.2f%%", vr_transaction_cg.data.get_coverage());
  endfunction
